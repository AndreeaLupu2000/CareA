...
from drink_patient import shared_display
    ...
    data = {
        ...
        "messages": [
            {"role": "system", "content": " You are an informational device in a hospital,"
                                        ...
                                        " consistently be: 'Water is essential because it hydrates the body,"
                                        " helps maintain organ function, aids in digestion, and eliminates"
                                        ...
                                        " If asked about today's meal, inform them: 'Dinner is scheduled to"
                                        " be served at 7 PM, featuring a nutritious meal of chicken with rice. "
                                        " We hope you find it enjoyable.'"
                                        " We someone inquires what food is served usually into a hospital,"
